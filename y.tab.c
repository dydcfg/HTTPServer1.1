...
static const YYINT yyrindex[] = {                         0,
 ...
 -222,    0,    0,    0,    0,    0,    0, -205,    0,    0,
    0,    0,    0,    0,    0, -205, -205,    0,    0,    0,
 -227,    0,    0,
};
static const YYINT yygindex[] = {                         0,
    1,  -23,  -10,   43,  -14,    0,    0,   39,
};
#define YYTABLESIZE 66
static const YYINT yytable[] = {                         21,
    5,   28,   24,   20,   30,   23,    9,    5,   28,   27,
    9,    5,   19,   20,   31,   29,    1,    2,    3,   26,
   32,   33,   13,    1,    2,    3,   12,   14,   15,   12,
   12,   12,   12,   12,   17,   12,   12,    1,    2,    3,
   19,   20,    6,   19,   20,   13,    1,    2,    3,   22,
   14,   15,   12,   12,   12,   12,    0,   12,   12,    1,
    2,    3,    0,    0,    0,    8,
};
static const YYINT yycheck[] = {                         10,
    0,   25,  265,  266,  257,  257,    6,    7,   32,   24,
   10,   11,  265,  266,   29,   26,  259,  260,  261,  263,
   31,  257,  258,  259,  260,  261,  263,  263,  264,  257,
  258,  259,  260,  261,  257,  263,  264,  259,  260,  261,
  265,  266,    0,  265,  266,  258,  259,  260,  261,   11,
  263,  264,  258,  259,  260,  261,   -1,  263,  264,  259,
  260,  261,   -1,   -1,   -1,  265,
};
#define YYFINAL 4
#ifndef YYDEBUG
...
"t_dot","t_token_char","t_lws","t_colon","t_separators","t_sp","t_ws",0,0,0,0,0,
...
#line 197 "parser.y"
	...
	YPRINTF("request_Header:\n%s\n%s\n",yystack.l_mark[-6].str,yystack.l_mark[-2].str);
        ...
        parsing_request->headers = realloc(parsing_request->headers, sizeof(Request_header)*(parsing_request->header_count));
        strcpy(parsing_request->headers[parsing_request->header_count - 1].header_name, yystack.l_mark[-6].str);
	strcpy(parsing_request->headers[parsing_request->header_count - 1].header_value, yystack.l_mark[-2].str);
}
break;
case 17:
#line 213 "parser.y"
